...
پیش از استفاده، یک نام کاربری و رمز عبور قوی برای مدیر تنظیم کنید. برای نمونه،
در محیط توسعه می‌توانید مقدارهای `Admin:Username` و `Admin:Password` را در
`appsettings.json` تغییر دهید. در محیط استقرار، از تنظیمات محیطی استفاده کنید تا
رمز در فایل پیکربندی نگهداری نشود:
...
رمز نمونهٔ پیش‌فرض عمداً قابل استفاده نیست؛ تا زمانی که مقدار آن تغییر نکند،
ورود به پنل انجام نمی‌شود.
